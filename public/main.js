...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    var Navigation = __webpack_require__(181).Navigation;

	    var Logs = __webpack_require__(220),
	        Streams = __webpack_require__(244);

	    var PeerActions = __webpack_require__(249);
	    ...
	    var Main = React.createClass({
	        ...
	        render: function render() {
	            return React.createElement(
	                ...
	                React.createElement(Streams, null),
	    ...
	    var routes = React.createElement(
	        ...
	        React.createElement(Route, { name: 'call', handler: Main })
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var util = __webpack_require__(6);
	var EventEmitter = __webpack_require__(10);
	var Negotiator = __webpack_require__(13);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(21), __webpack_require__(22).setImmediate, __webpack_require__(23)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(26),
	    Reflux = __webpack_require__(221);

	var LogStore = __webpack_require__(242);
	...
	module.exports = React.createClass({
	    ...
	    onLogsChange: function onLogsChange(logs) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ActionMethods = __webpack_require__(224);

	exports.ListenerMethods = __webpack_require__(225);

	exports.PublisherMethods = __webpack_require__(235);

	exports.StoreMethods = __webpack_require__(236);

	exports.createAction = __webpack_require__(237);

	exports.createStore = __webpack_require__(231);

	exports.connect = __webpack_require__(238);

	exports.connectFilter = __webpack_require__(239);

	exports.ListenerMixin = __webpack_require__(240);

	exports.listenTo = __webpack_require__(223);

	exports.listenToMany = __webpack_require__(241);
	 ...
	 */
	exports.__keep = __webpack_require__(232);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(222);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(22).setImmediate))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(226),
	    Reflux = __webpack_require__(222),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ = __webpack_require__(226),
	    ListenerMethods = __webpack_require__(225);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LogActions = __webpack_require__(243);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Reflux.createActions(['addLog']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StreamStore = __webpack_require__(245),
	    StreamActions = __webpack_require__(246);

	var Video = __webpack_require__(247);
	...
	module.exports = React.createClass({
	    ...
	    render: function render() {
	        var endCallButton, remoteVideoStream;

	        if (this.state.remoteStream) {
	            endCallButton = React.createElement(
	                'div',
	                { className: 'end-call' },
	                React.createElement(
	                    'button',
	            ...
	            remoteVideoStream = React.createElement(Video, { stream: this.state.remoteStream });
	        } else if (this.state.waiting) {
	            remoteVideoStream = React.createElement(
	                'div',
	                null,
	                React.createElement(
	                    'p',
	            ...
	            remoteVideoStream = React.createElement(
	                ...
	                React.createElement(
	                    'button',
	                    { id: 'find-partner', onClick: this.handleFindPartner },
	                    'Find a partner'
	                )
	            );
	        }
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(Video, { stream: this.state.localStream })
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'container-item' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Reflux = __webpack_require__(221),
	    RSVP = __webpack_require__(20);

	var PeerStore = __webpack_require__(248);

	var StreamActions = __webpack_require__(246),
	    PeerActions = __webpack_require__(249);
	...
	module.exports = Reflux.createStore({
	    ...
	    init: function init() {
	        ...
	        initLocalStream().then(function (localStream) {
	            PeerActions.init();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PeerActions = __webpack_require__(249),
	    PeerUtils = __webpack_require__(250);
	...
	module.exports = Reflux.createStore({
	    ...
	    onLoad: function onLoad() {
	        PeerUtils.createPeerConnection(this, PeerActions).then(this.setPeerConnection.bind(this));
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	Actions.findPartner.listen(function findPartner() {
	    request.get('/streamer').query({ myId: Actions.getCallId() }).end(function (err, res) {
	        if (err || !res.ok) {
	            this.failed(err);
	...
	Actions.findPartner.callRemote.listen(function callRemote(remoteCallId) {
	    ...
	    StreamActions.getLocalStream().then(function (myMediaStream) {
	        ...
	        _this.handleCall(call).then(_this.completed.bind(_this));
	    });
	});
	...
	Actions.findPartner.waitForCall.listen(function waitForCall() {
	    ...
	    Actions.getPeerConnection().on('call', function (call) {
	        ...
	        _this2.handleCall(call).then(function () {
	            request.del('/streamer/' + Actions.getCallId()).end(function (err, res) {
	                if (err || !res.ok) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RSVP = __webpack_require__(20),
	    Peer = __webpack_require__(5);
	...
	function handleConnectionTrouble(PeerStore) {
	    if (!connectionTroubleTimeoutId) {
	        retries++;
	        connectionTroubleTimeoutId = setTimeout(function () {
	            createPeerConnection(PeerStore).then(function (peerConnection) {
	                return PeerStore.setPeerConnection(peerConnection);
	            });
	...
	function createPeerConnection(PeerStore) {
	    ...
	    return new RSVP.Promise(function (resolve) {
	        ...
	        if (!callId) peerConnection = new Peer(options);else peerConnection = new Peer(callId, options);

	        peerConnection.on('open', function () {
	            retries = 0;
	            if (!setIntervalId) setIntervalId = setInterval(pingHeroku.bind(_this, PeerStore), 1000);

	            resolve(peerConnection);
	        });

	        peerConnection.on('disconnected', handleConnectionTrouble.bind(_this, PeerStore));
	        peerConnection.on('error', handleConnectionTrouble.bind(_this, PeerStore));
	    });
	}
